    ...
    <div className="min-h-screen bg-[radial-gradient(circle_at_top_right,_rgba(129,140,248,0.16),transparent_38%),radial-gradient(circle_at_top_left,_rgba(16,185,129,0.10),transparent_32%)] bg-slate-50">
        ...
        <div className="mx-auto max-w-6xl px-4 py-3">
          <div className="rounded-2xl border border-slate-200/80 bg-gradient-to-r from-white via-indigo-50/60 to-cyan-50/70 p-2 shadow-sm">
            <div className="flex flex-wrap items-center justify-between gap-3">
              <Link
                to="/"
                className="inline-flex items-center gap-2 rounded-xl px-2 py-1 transition hover:bg-white/80"
              >
              ...
              <nav className="flex flex-wrap items-center gap-2">
                <NavLink
                  to={isAuthenticated ? "/owner/dashboard" : "/"}
                  className={linkClass}
                >
      ...
      <footer className="mt-16 border-t border-slate-200/80 bg-white/80 backdrop-blur-xl">
        <div className="mx-auto max-w-6xl px-4 py-10">
          <div className="rounded-2xl border border-slate-200/80 bg-gradient-to-r from-white via-indigo-50/60 to-cyan-50/70 p-6 shadow-sm">
              ...
              <div>
                ...
                >
                  <div>
                    ...
                    <p className="text-xs text-slate-500">
                      Быстрое бронирование клубов и ресурсов. Один стиль, один
                      поток — без лишних шагов.
                    </p>
                  </div>
                </Link>
